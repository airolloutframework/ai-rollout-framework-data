...
| [qa-dataset.json](qa-dataset.json) | Structured Q&A dataset — every FAQPage entry live on the site, compiled and deduplicated |
...
[qa-dataset.json](qa-dataset.json) is a flat JSON array of every
